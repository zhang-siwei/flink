...
/**
 * @author zhang.siwei
 * @time 2022-12-17 0:25
 * @action
 * 每个key有自己的定时器，互相不影响。
 */
public class Demo3_MultiKeyTimer {
        ...
        env.socketTextStream("localhost", 8888)
                ...
                .process(new KeyedProcessFunction<String, WaterSensor, String>() {
                    ...
                    public void onTimer(long timestamp, KeyedProcessFunction<String, WaterSensor, String>.OnTimerContext ctx, Collector<String> out) throws Exception {
                        out.collect(ctx.getCurrentKey()+"预警..........");
                    }
                    ...
                    public void processElement(WaterSensor waterSensor, Context context, Collector<String> collector) throws Exception {
                        ...
                        if (waterSensor.getVc() > 30) {
                            ...
                            System.out.println(context.getCurrentKey()+"注册了定时器:" + time);
                        } else if (waterSensor.getVc() <= 10) {
                            timerService.deleteEventTimeTimer(time);
                            System.out.println(context.getCurrentKey()+"删除了定时器:" + time);
                        }
                    }
                })
                .print();
